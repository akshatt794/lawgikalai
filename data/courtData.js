const courtData = {
    ...
    highcourt: [
      { name: "Allahabad High Court", link: "http://www.allahabadhighcourt.in/" },
      { name: "Andhra Pradesh High Court", link: "https://aphc.gov.in/" },
      { name: "Bombay High Court", link: "https://bombayhighcourt.nic.in/" },
      { name: "Calcutta High Court", link: "https://www.calcuttahighcourt.gov.in/" },
      { name: "Chhattisgarh High Court", link: "https://highcourt.cg.gov.in/" },
      { name: "Delhi High Court", link: "https://delhihighcourt.nic.in/" },
      { name: "Gauhati High Court", link: "https://ghconline.gov.in/" },
      { name: "Gujarat High Court", link: "https://gujarathighcourt.nic.in/" },
      { name: "Himachal Pradesh High Court", link: "https://hphighcourt.nic.in/" },
      { name: "Jammu & Kashmir High Court", link: "https://jkhighcourt.nic.in/" },
      { name: "Jharkhand High Court", link: "https://jharkhandhighcourt.nic.in/" },
      { name: "Karnataka High Court", link: "https://karnatakajudiciary.kar.nic.in/" },
      { name: "Kerala High Court", link: "https://hckerala.gov.in/" },
      { name: "Madhya Pradesh High Court", link: "https://mphc.gov.in/" },
      { name: "Madras High Court", link: "https://www.hcmadras.tn.nic.in/" },
      { name: "Manipur High Court", link: "https://hcmimphal.nic.in/" },
      { name: "Meghalaya High Court", link: "https://meghalayahighcourt.nic.in/" },
      { name: "High Court of Orissa", link: "https://orissahighcourt.nic.in/" },
      { name: "Patna High Court", link: "https://patnahighcourt.gov.in/" },
      { name: "Punjab & Haryana High Court", link: "https://highcourtchd.gov.in/" },
      { name: "Rajasthan High Court", link: "https://hcraj.nic.in/" },
      { name: "Sikkim High Court", link: "https://hcs.gov.in/" },
      { name: "Telangana High Court", link: "https://tshc.gov.in/" },
      { name: "Tripura High Court", link: "https://thc.nic.in/" },
      { name: "Uttarakhand High Court", link: "https://highcourtofuttarakhand.gov.in/" }
    ],
    districtcourt: [
      {
